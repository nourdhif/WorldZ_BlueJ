    ...
    public void setForegroundColour(Colour colour)
    {
        switch(colour) {
            ...
            case PURPLE  : graphic.setColor(new Color(138, 43, 226));
                            break;
            case PINK  : graphic.setColor(new Color(255, 140, 255));
                            break; 
            case LIME  : graphic.setColor(new Color(140, 255, 90));
                            break;
            case ORANGE  : graphic.setColor(new Color(255, 100, 0));
                            break;
            case GREY  : graphic.setColor(new Color(128, 128, 128));
                            break;
        }
